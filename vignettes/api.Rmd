...
ggplot() +
  ...
  geom_line(data = pst, aes(x = utc$dateTime, 
                            ...
                            color = "PST")) +
  theme_bw() +
  labs(y = 'Flows', x = "DateTime", title = "Time Zone Comparison", color = "Timezone") + theme(legend.position = "bottom")
```
...
ggplot(data = pst_vs) + 
  ...
  geom_line(aes(x = dateTime, y = flow_cms_v2, color = "v2")) +
...
```{r}
pst_obs = readNWMdata(siteID = 11120000, 
                    startDate = "2010-01-01", 
                    endDate   = "2010-01-31",
                    version =  c(1.2, 2.0, 2.1),
                    addObs = TRUE)
...
ggplot(data = pst_obs) + 
  ...
  labs(y = 'Flows', x = "DateTime", title = "Model Comparison vs Obs", 
       color = "Model") + 
  theme_bw() +
  theme(legend.position = "bottom")
```
